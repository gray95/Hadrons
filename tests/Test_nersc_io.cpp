...
int main(int argc, char *argv[])
{
    ...
    LatticeGaugeField prop(grid);
    //Metadata          md, testMd;
    MIO::SaveNerscPar      metadata;

    random(rng, prop);

    metadata.gauge = "string"; // name of gauge field
    metadata.fileStem = "more_string"; // stem of filename
    metadata.ensembleLabel = "test"; // add suffix gauge_fixed_su3
    metadata.ensembleId = "telos"; // collaboration label
/*
